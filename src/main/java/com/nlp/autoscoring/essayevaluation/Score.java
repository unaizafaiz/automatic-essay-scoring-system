    ...
    public void findCriteriaAndScore(File[] files){
        ...
        for(File file: files) {
           ...
           // wordCount = Integer.parseInt(mistake[1]);
            ...
            topicCoherence.put(file.getName(),topicCoher.checkforcoherence(file,fileContents));
        }
      ...
      /* System.out.println(grade);
       ...
       HashMap<String, String> fileGrades = getExpectedGrades();
        ...
        try {
            ...
            for (File file: files){
                writer.println(file.getName()+";"+lengthMarks.get(file.getName())+";"+spellingMarks.get(file.getName())+";"+agreementMarks.get(file.getName())+";"+verbMissing.get(file.getName())+";"+sentenceForming.get(file.getName())+";0; "+topicCoherence.get(file.getName())+"; "+finalScores.get(file.getName())+"; "+grade.get(file.getName()));
                scoreEssay.println(file.getName()+"; "+lengthMarks.get(file.getName())+"; "+spellingMarks.get(file.getName())+"; "+agreementMarks.get(file.getName())+"; "+verbMissing.get(file.getName())+";"+sentenceForming.get(file.getName())+"; 0; "+topicCoherence.get(file.getName())+"; "+finalScores.get(file.getName())+"; "+finalScoresNormalised.get(file.getName())+"; "+grade.get(file.getName())+";"+fileGrades.get(file.getName()));
